...
resource "aws_s3_object" "provision_source_files" {
  ...
  key    = "raw_sales_data.csv"         # The S3 object key (this is the file name in the bucket)
  source = "../data/raw_sales_data.csv" # Local path to the CSV file in your project folder
}
